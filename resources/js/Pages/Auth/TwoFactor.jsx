    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div className="bg-white p-8 rounded-xl shadow-sm w-full max-w-md border border-gray-100">
                ...
                <h2 className="text-center text-gray-500 mb-2 text-sm">Two-Factor Verification</h2>
                <p className="text-center text-xs text-gray-400 mb-8">Enter the 6-digit code sent to your email</p>
                ...
                <p className="text-center mt-6 text-xs text-gray-400">
                    Didn't get the code? <a href="/login" className="text-green-700 hover:underline">Try logging in again</a>
                </p>
            </div>
        </div>
    );
