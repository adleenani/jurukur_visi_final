            ...
            <div className="min-h-screen bg-white">
                ...
                <section className="bg-green-800 text-white py-24 px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-green-200 text-lg mb-8 max-w-2xl mx-auto">
                            Jurukur Visi Sdn Bhd — a Bumiputera-owned
                            consultancy delivering precision surveying solutions
                            across Malaysia since 2005.
                        </p>
                    ...
                    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 leading-relaxed mb-4">
                                Based in Sungai Buloh, Selangor, we specialise
                                in advanced mapping and surveying solutions for
                                government and private sector clients across
                                Malaysia.
                            </p>
                            <p className="text-gray-600 leading-relaxed">
                                With over 12 years of experience, our licensed
                                surveyors bring precision, professionalism and
                                deep local expertise to every project.
                            </p>
                        </div>
                ...
                <section className="py-20 px-6 bg-green-800 text-white text-center">
                    ...
                    <p className="text-green-200 mb-8">
                        Book a consultation and get a project quote from our
                        team.
                    </p>
                    <Link
                        href="/contact"
                ...
                <footer className="bg-gray-900 text-gray-400 py-8 px-6 text-center text-sm">
                    <p>
                        © {new Date().getFullYear()} Jurukur Visi Sdn Bhd ·
