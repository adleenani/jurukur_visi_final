// Projects/Create.jsx — Add a new surveying project.
        ...
        <AdminLayout>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Field label="Project Name" error={errors.project_name}>
                            <input
                                ...
                                onFocus={onFocus}
                                onBlur={onBlur}
                                placeholder="e.g. Boundary Survey — Klang Valley"
                                required
                            />
                        </Field>
                    ...
                    {/* Row 2: Start Date · End Date · Location · Service Type */}
                    <div
                        style={{
                            display: "grid",
                        ...
                        <div
                            style={{
                                background: duration.startsWith("⚠")
                                    ? "#fef2f2"
                                    : "#f0fdf4",
                                border: `1px solid ${duration.startsWith("⚠") ? "#fecaca" : "#bbf7d0"}`,
