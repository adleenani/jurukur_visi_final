    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-3xl mx-auto px-6 py-16">
                <h1 className="text-3xl font-medium text-green-800 mb-2">Book a Consultation</h1>
                <p className="text-gray-500 mb-10 text-sm">
                    Fill in the form below and our team will confirm your appointment within 1–2 business days.
                </p>
                ...
                <form onSubmit={submit} className="bg-white rounded-xl border border-gray-100 p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="block text-sm text-gray-600 mb-1">Service Required</label>
                                <select
                            ...
                            <div>
                                <label className="block text-sm text-gray-600 mb-2">Consultation Type</label>
                ...
                <div className="mt-10 grid md:grid-cols-3 gap-6 text-center text-sm text-gray-500">
                    {[
                        { label: 'Address', value: 'Sungai Buloh, Selangor' },
